...
#   docker build --build-arg OPENCLAW_VERSION=v2026.4.23 -t ghcr.io/everclaw/everclaw:latest .
#
# Run:
#   docker run -d \
#     -p 18789:18789 \
...
ARG OPENCLAW_VERSION=v2026.4.23
...
ARG EVERCLAW_VERSION=2026.4.25.0259
